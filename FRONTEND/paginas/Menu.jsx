          ...
          : (
            <div className="grid grid-cols-1 gap-12">
              {listaItens.length != 0 || todosItens.length != 0 ?
                listaItens.map((iten, index) => (<Item key={index} nome={iten["NomeItem"]} preco={iten["Preco"].toFixed(2)} ingredientes={iten["Ingredientes"]} tipo={iten["TipoItem"]} ID={iten["ID_item"]}/>))
                : <div className="text-center text-gray-400 py-8">
