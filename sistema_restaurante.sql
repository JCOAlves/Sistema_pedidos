...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19/12/2025 às 21:42
...
(22, 'Hambúrguer Clássico', 'Prato', 'Pão, carne bovina, queijo, alface, tomate', 25),
(23, 'X-Bacon', 'Prato', 'Pão, carne bovina, queijo, bacon, maionese', 28),
(24, 'Pizza Margherita', 'Prato', 'Massa, molho de tomate, mussarela, manjericão', 42),
(25, 'Batata Frita', 'Prato', 'Batata, óleo e sal', 15),
(26, 'Cheeseburger Duplo', 'Prato', 'Pão, duas carnes bovinas, queijo cheddar, cebola', 32),
(27, 'X-Salada', 'Prato', 'Pão, carne bovina, queijo, alface, tomate, maionese', 27),
(28, 'Pizza Calabresa', 'Prato', 'Massa, molho de tomate, mussarela, calabresa e cebola', 45),
(29, 'Pizza Quatro Queijos', 'Prato', 'Massa, mussarela, provolone, parmesão, gorgonzola', 48),
(30, 'Refrigerante Lata', 'Bebida', 'Refrigerante de 350ml', 6),
(31, 'Suco Natural de Laranja', 'Bebida', 'Laranja natural', 8.5),
(32, 'Suco de Maracujá', 'Bebida', 'Polpa de maracujá e água', 8.5),
(33, 'Suco de Limão', 'Bebida', 'Limão, água e açúcar', 7.5),
(34, 'Água Mineral', 'Bebida', 'Água sem gás 500ml', 4);
